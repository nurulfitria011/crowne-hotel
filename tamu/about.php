        ...
        <header id="header">
            ...
            <nav class="main-menu top-menu">
                <ul>
                    ...
                    <li class="active"><a href="..tamu//about.php">About Us</a></li>
        ...
        <div id="about">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 content-cols">
                        <div class="content-col">
                            <h3>Crowne Hotel</h3>
                            <p>
                                Crowne Hotel merupakan salah satu  hotel strategis yang terletak dipusat Kota Bandung, Kesempurnaan lokasi ini berpadu memberikan pengalaman liburan hingga meeting yang sempurna untuk wisatawan modern.
                            </p>
                            <p>
                                Suite yang didesain dengan elegan dan menawarkan pemandanngan kota Bandung  serta deretan pegunungan yang mengelilingi kota Bandung.
                            </p>
                            <a href="#">Learn More</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 content-cols">
                        <div class="content-col">
                            <h3>Perjalanan Bisnis & Liburan Menyenangkan</h3>
                            <p>
                               Crowne Hotel, pilihan yang tepat untuk anda yang menginginkan pengalaman yang berbeda, dengan konsep modern yang berbalut kebudayaan lokal yang tertuang dalam bentuk fasilitas dan pelayanan terbaik.
                            </p>
                            <p>
                                Fasilitas dan pelayanan terbaik kami ciptakan untuk pengalaman yang tak terlupakan.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 content-cols">
                        <div class="content-col">
                            <h3>Keindahan, Kenyamanan, Kemewahan</h3>
                            <p>
                                Terinspirasi oleh sejuknya nuansa alam yang ada di Crowne Hotel  dan mewahnya fasilitas hotel. Dengan menyatukan elemen-elemen tersebut, maka terciptalah sebuah hotel berkelas dan nyaman, semua ada di Crowne Hotel.
                            </p>
                            <p>
                                Semua kemewahan dan kenyamanan itu bisa anda dapatkan sekaligus di Crowne Hotel.
                            </p>
                        </div>
                    </div>
                </div>
