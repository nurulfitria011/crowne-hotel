        ...
        <div id="booking">
            <div class="container">
                <div class="section-header">
                    ...
                    <div class = "well" style = "height:300px; width:100%;">
                        ...
                        <p><img width="350" height="235 alt=" src="../img/room/room-1.jpg" style="float:left; margin-right:40px;padding-top: 10px"></p>
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" id="nama_tamu" placeholder="" value="<?php echo $row['nama_tamu'];?>" name="nama_tamu" readonly>
              ...
              <input type="text" class="form-control" placeholder="" name="nama_tamu" required>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="kamar" placeholder="" name="nama_kamar" required>
              <!-- <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" class="form-control" id="lastName" placeholder="jumlah kamar" name="jml_kamar_dipesan" min=1 max="<?php echo $kamar['jml_kamar_dipesan'];?>"required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" class="form-control" id="lastName" placeholder="jumlah orang" name="jml_orang" min=1 max="<?php echo $kamar['batas_orang'];?>" required>
              <div class="invalid-feedback">
          ...
          <br>
          <button type="submit" class=" btn btn-primary"><a href="sdhpesan.php">PESAN</button>
