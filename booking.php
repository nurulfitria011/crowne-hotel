...
<html lang="en">
    ...
    <body>
        ...
        <header id="header">
            <a href="index.html" class="logo"><img src="img/logo_hotel.png" alt="logo"></a>
            ...
            <nav class="main-menu top-menu">
                <ul>
                    ...
                    <li><a href="daftar.php"><button type="button" class="btn btn-warning">Sign-up</button></a></li>
                </ul>
            </nav>
        </header>
        <!-- Header Section End -->
            ...
            <div class="container">
                <div class="section-header">
                    ...
                    <div class = "well" style = "height:300px; width:100%;">
                       ...
                       <p><img width="350" height="235 alt=" src="" style="float:left; margin-right:40px;padding-top: 10px"></p>
                     </div>
                     </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <form name="sentMessage" id="bookingForm" novalidate="novalidate">
                                <div class="form-row">
                                    <div class="control-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="" required="required" data-validation-required-message="Please enter first name" />
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group col-md-6">
                                        <label>Last Name</label>
                                        <input type="text" class="form-control" id="lname" placeholder="" required="required" data-validation-required-message="Please enter last name" />
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="control-group col-md-6">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control" id="alamat" placeholder="" required="required" data-validation-required-message="Please enter your addres" />
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group col-md-6">
                                        <label>Email</label>
                                ...
                                <div class="form-row">
                                    <div class="control-group col-md-6">
                                        ...
                                        <input type="text" class="form-control datetimepicker-input" id="date-1" data-toggle="datetimepicker" data-target="#date-1" placeholder="MM/DD/YYYY" required="required" data-validation-required-message="Please enter date"/>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group col-md-6">
                                        <label>Check-Out</label>
                                        <input type="text" class="form-control datetimepicker-input" id="date-2" data-toggle="datetimepicker" data-target="#date-2" placeholder="MM/DD/YYYY" required="required" data-validation-required-message="Please enter date"/>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label>Special Request</label>
                                    <input type="text" class="form-control" id="request" placeholder="" required="required" data-validation-required-message="Please enter your special request" />
                                    <p class="help-block text-danger"></p>
                                </div>
