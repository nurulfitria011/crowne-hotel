      ...
      <div class="container">
           ...
           <div class="form-group" class="mb-3">
              <label style="width:100%;">
                 Nama Lengkap
                 <input  type="text" name="nama_user" class="form-control" value="<?php echo "$nama_user"; ?>" placeholder="Masukan Nama lengkap Anda">
             </label>
           </div>   
           ...
           <div class="form-group">
             <label style="width:100%;">
                 No Telp
                 <input type="number" name="no_telp" class="form-control" placeholder="Masukan notelp Anda" value="<?php echo "$no_telp"; ?>" >
             </label>
         </div> 
